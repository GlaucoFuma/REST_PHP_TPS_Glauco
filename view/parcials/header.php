...
<head>
  ...
  <link rel="icon" href="/Res/Img/ico.png">
  ...
  <link rel="stylesheet" type="text/css" href="/RES/CSS/styleClass.css">

  <!-- Link al file JS -->
  <script src="/RES/JS/classi.js"></script>
  <script src="/RES/JS/funzioni.js"></script>
    ...
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row header-style">
        ...
        <nav class="mdl-navigation">
          <a class="mdl-navigation__link" onclick="location.href='/dashboard'" methods="post">
...
<!--          <a class="mdl-navigation__link" onclick="exitFromUp()">-->
        ...
        <a class="mdl-navigation__link" href="/listaEsercenti"><i class="material-icons md-ip">list</i> Lista
          ...
          <a class="mdl-navigation__link" href="/aggiungiEsercente"><i class="material-icons md-ip">person_add</i>
            ...
            <a class="mdl-navigation__link" href="/aggiungiCodiceSconto"><i
              ...
              <div class="mdl-layout-spacer"></div>
              <a class="mdl-navigation__link" href="/segnalaBug" methods="post"><i class="material-icons md-ip">feedback</i> Feedback</a>
            </nav>
          </div>
